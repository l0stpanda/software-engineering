...
const BarChartPieChart = () => {
    ...
    const [totalStuff, setTotalStuff] = useState<totals>({
     ...
     useEffect(() => {
        ...
        const allTasks = totalStuff.unassigned_count + totalStuff.assigned_count + totalStuff.inProg_count + totalStuff.closed_count;
        const completedTasksPercent = (totalStuff.closed_count / (allTasks) * 100).toFixed(0);
                ...
                <div className="mt-[10rem] flex flex-row">
                    ...
                    <ResponsiveContainer width={850} height={400}>
                        <BarChart data={barData}>
                            ...
                            <XAxis dataKey="name"
                                   className="font-header text-[15px]"/>
                            <YAxis
                                tickCount={8}
                                domain={[0, 'dataMax + 11']}
