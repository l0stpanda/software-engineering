  ...
  return (
      <div className="wholePage">
          <div className="header">
              ...
              <h1 className="bHead">Transforming Medicine <br/>Through Life-giving <br/>Breakthroughs</h1>
          </div>
          <div className="heroSecondCol">
            <button className="touchToStart">
                <h1 className="touchStartText"><strong>Touch here to view the map</strong></h1>
            </button>
