        ...
        <div className="">
            ...
            <div className="flex flex-row justify-evenly align-center">
                <Button
                    ...
                    className="zoomInBut"
                    size="medium"
                    sx={{ borderRadius: "30px", fontSize: "22px", font: "header", height: "50px"}}
                >
                    &lt;
                </Button>
                <a href={allText[textIndex].url} className="flex text-primary font-bold text-5xl text-center px-20 h-fit justify-center py-20 gap-4 -m-5 underline">
